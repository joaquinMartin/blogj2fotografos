...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name'=>'admin.home', 
                            'description' =>'pagina principal'])->syncRoles([$role1, $role2]);

        Permission::create(['name'=>'admin.users.index', 
                            'description' =>'Ver listado de usuarios'])->syncRoles([$role1, $role2]);
        Permission::create(['name'=>'admin.users.edit', 
                            'description' =>'Asignar un rol'])->syncRoles([$role1, $role2]);
    /*     Permission::create(['name'=>'admin.users.update', 
                            'description' =>'Actualizar'])->syncRoles([$role1, $role2]); */
        ...
        Permission::create(['name'=>'admin.tags.destroy', 
                            'description' =>'Eliminar etiquetas'])->syncRoles([$role1, $role2]);
...
// assingRoles = permiso solo a 1 
//syncRoles  =  permisos para varios roles
